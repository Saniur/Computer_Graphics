...
int main(int argc, char** argv)
{
    ...
    cout << endl << "*********** Army Camp View********************" << endl << endl;
    ...
    cout << "          COMPUTER GRAPHICS [H]           " << endl ;
    cout << "  Project Submission [ Summer 2020-2021 ]" << endl << endl;
    cout << "Submitted To : Md. Kishor Morol " << endl << endl;
    cout << "Submitted By : Saniur Rahman Sakib, 18-37111-1" << endl ;
    cout << "\n\n        Thank you!     " << endl << endl;
